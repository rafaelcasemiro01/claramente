...
export default function Home() {
  ...
  const {
    messages, isTyping, isCrisis, conversationId,
    conversations, sendMessage, resetChat, loadConversation,
  } = useChat()
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 4 }}>
            {[
              { icon: isDark ? '☀️' : '🌙', action: toggle, title: 'Alternar tema' },
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
        ...
        <header
          ...
          <button
            ...
            style={{ padding: 8, background: 'none', border: 'none', cursor: 'pointer', color: t.violet, display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ maxWidth: 680, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            {messages.length === 0 && (
              <div style={{ textAlign: 'center', padding: '52px 20px 20px', animation: 'fadeUp 0.5s ease' }}>
                <div style={{
                  width: 60, height: 60, borderRadius: '50%', background: t.violetBg,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  margin: '0 auto 18px',
                }}>
                  <CrystalLogo size={34} />
            ...
            {messages.map(msg => (
              <div
                ...
                {msg.role === 'assistant' && (
                  <div style={{
                    width: 32, height: 32, borderRadius: '50%', background: t.violetBg,
          ...
          <div style={{ maxWidth: 680, margin: '0 auto' }}>
            <div
              style={{
                ...
                border: `1.5px solid ${t.inputBorder}`, transition: 'border-color 0.2s',
              }}
