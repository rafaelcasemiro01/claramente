  ...
  return (
    <svg width={size} height={size} viewBox="0 0 56 56" fill="none">
      ...
      <line
        ...
        x2="28"
        y2="30"
        stroke={light ? "rgba(255,255,255,0.5)" : "rgba(139,92,246,0.6)"}
        strokeWidth="1.2"
      />
      <line
        x1="50"
              ...
              {group.items.map((conv) => (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background:
                      conversationId === conv.id ? SB.active : "transparent",
                    marginBottom: 2,
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "flex-end" }}>
                ...
                <div
                  style={{
                    ...
                    border: `0.5px solid ${t.botBorder}`,
